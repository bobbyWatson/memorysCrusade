define(["Game", "Run", "BouncingBall", "MovingPlateform", "Player", "GrabPoint", "B2D", "Ladder", "StaticPlateform", "Camera", "Spawn", "LevelController","Spike"], 
	function (Game, Run, BouncingBall, MovingPlateform, Player, GrabPoint, Box2D, Ladder, StaticPlateform, Camera, Spawn, LevelController,Spike){
	return function Init(){
		...
		Game.gameObjects.push(new Spike({x : 15, y : 10,  height : 2}));
