define(["Game", "Run", "BouncingBall", "Player", "GrabPoint", "B2D", "Ladder", "StaticPlateform", "Camera", "Spawn"], 
	function (Game, Run, BouncingBall, Player, GrabPoint, Box2D, Ladder, StaticPlateform, Camera, Spawn){
